...
function App() {
    ...
    }, [extremeRoundSource, roundCount, handleThemeChange]);
    ...
    const renderContent = () => {
        ...
        const canSpin = !isSpinInProgress && (!modalState.type || modalState.type === 'closing') && (gameState === 'playing' || (gameState === 'extremeRound' && extremeModeReady));
